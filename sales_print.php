 ...
 $customer_id = $line['customer_id'];
   $line['date'];
        ...
        <tr>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="30" align="center"><strong>Sale Invoice</strong></td>
        </tr>
...
?>
<table >
<td align="left"> Date <?php echo $line['date'];?></td>     <td>&nbsp;</td> <td align="center">Payment Mode:<strong><?php echo $line['mode'] ?></strong></td>  
...
<tr><td><br>&nbsp;Description:- <?php echo $line['description'];?></td>
</tr>
        <tr>
          <td width="45"><hr></td>
        </tr>
...
<tr>
            ...
            <tr>
              <td width="150"><strong>Payable Amount </strong></td>
              <td width="150">&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(subtotal) FROM stock_sales where count1=1 AND transactionid = '$transaction_id' ");?></td>
            </tr>
            <tr>
           ...
           <tr>
              <td width="150"><strong>Tax <i>(15% included on Total) </i></strong></td>
              <td width="150">&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(tax) FROM stock_sales where count1=1 AND transactionid = '$transaction_id' ");?></td>
            </tr>
...
Note:- Payment can also be made by bank transfer into Account No- <b>060405025919200 ANZ Bank</b> Account name- <b>Building Materials Supply Limited</b>
</p>
</footer>
