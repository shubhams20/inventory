...
<body>
	...
	<div id="content">
		...
		if($count>=1)
			{
	                                     $data='Dublicate Entry. Please Verify';
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
			...
			if($db->query("insert into supplier_details values(NULL,'$name','$address','$contact1','$contact2','$email','$gst',0)"))
			{
                  ...
                  <table class="form"  border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td><textarea name="address" placeholder="ENTER YOUR ADDRESS"cols="8" class="round full-width-textarea"><?php echo $address; ?></textarea></td>
                        <td>Contact2</td>
                      <td><input name="contact2"placeholder="ENTER YOUR PHONE No." type="text" id="sellingrate" maxlength="20"  class="round default-width-input" 
                    ...
                    <tr>
                      <td>Email Id </td>
                      <td><input name="email" placeholder="ENTER YOUR EMAIL"type="text" id="buyingrate" maxlength="30"   class="round default-width-input" 
					  value="<?php echo $email; ?>" /></td>
					  <td>GST No. </td>
                      <td><input name="gst" placeholder="ENTER YOUR GST NO."type="text" id="buyingrate" maxlength="20"   class="round default-width-input" 
					  value="<?php echo $gst; ?>" /></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
