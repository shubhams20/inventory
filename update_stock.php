...
<head>
	<meta charset="utf-8">
	<title>Inventory - Update Stock</title>
...
<body>
	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			$wholesalesell=trim(mysql_real_escape_string($_POST['wholesalesell']));
			...
			if($db->query("UPDATE stock_details  SET stock_name ='$name',supplier_id='$supplier',company_price='$cost',selling_price='$sell',wholesale_selling_price='$wholesalesell',category='$Category'where id=$id"))
			{ 
...
<link rel="stylesheet"  href="dist/js/jquery.alerts.css" >
		...
		<form name="form1" method="post" id="form1" action="">
                   ...
                   <td>Category </td>
                    ...
                    <td>Selling Price </td>
                      <td><input name="sell"  type="text" id="sell" maxlength="20"  class="round default-width-input" 
                                 value="<?php echo $line->selling_price ; ?>"onkeypress="return numbersonly(event)" /></td>
                    <td>WholeSale Selling Price </td>
                      <td><input name="wholesalesell"  type="text" id="wholesalesell" maxlength="20"  class="round default-width-input" 
                                 value="<?php echo $line->wholesale_selling_price ; ?>"onkeypress="return numbersonly(event)" /></td>
                    </tr>
                    <tr>
                        <td></td>
                             <td>Supplier Name  </td>
