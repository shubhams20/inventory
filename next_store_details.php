...
<?php include_once("analyticstracking.php") ?>
    ...
    $db->query("UPDATE store_details  SET mobile='".$mobile."',city='".$city."',name='".$name."',email='".$email."',web='".$web."',address='".$address."',place='".$place."',phone='".$phone."' ");
...
//('".$_POST['sname']."', '".$_POST['address']."', '".$_POST['place']."', '".$_POST['city']."', '".$_POST['phone']."', '".$_POST['email']."', '".$_POST['website']."', '".$_POST['pin']."')";
	...
	<div id="content">
		...
		<table><tr><td>
				...
				<p>
                                    <label>Mobile</label>
                                    <input type="text" name="mobile" id="mobile" class="round full-width-input" placeholder="Enter Mobile"  autofocus  /> 
                                </p>
...
<script type="text/javascript">
    ...
    </script><p>Any Queries email to <a href="mailto:shubhamsharma24@gmail.com?subject=Stock%20Management%20System">shubhamsharma24@gmail.com</a>.</p>
