...
$SQL = "SELECT DISTINCT(stock_id) FROM  stock_entries WHERE stock_id LIKE '%".$_POST['searchtxt']."%' ";
...
$query = "SELECT COUNT(DISTINCT stock_id) as num FROM stock_entries  WHERE stock_id LIKE '%".$_POST['searchtxt']."%' ";
...
$sql = "SELECT * FROM stock_entries WHERE stock_name LIKE '%".$_POST['searchtxt']."%' AND type='entry'";
...
<td><?php  $mysqldate=$row['date'];
	...
	<td>
        <a  href="javascript:confirmSubmit(<?php echo $row['id']?>,'stock_entries','view_purchase.php')" class="table-actions-button ic-table-delete"></a>		
	
        <a href="update_purchase.php?sid=<?php echo $row['id'];?>"	class="table-actions-button ic-table-edit">
	</a>
	</td>
