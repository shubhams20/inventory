...
<tr>
            ...
            <tr>
              ...
              <td>&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(subtotal) FROM stock_sales where count1=1  AND billnumber = '$sellid' ");?></td>
            </tr>
           ...
           <tr>
              ...
              <td>&nbsp;<?php echo  $age = $db->queryUniqueValue("SELECT sum(tax) FROM stock_sales where count1=1 AND billnumber = '$sellid' ");?></td>
            </tr> 
