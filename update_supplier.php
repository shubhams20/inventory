...
<head>
	<meta charset="utf-8">
	<title>Inventory - Update Supplier</title>
...
<body>
	...
	<div id="content">
		...
		<div class="page-full-width cf">
			...
			if($count>0){
			$db->query("UPDATE supplier_details  SET supplier_name ='$name',supplier_address='$address',supplier_contact1='$contact1',supplier_contact2='$contact2',email='$email',gst='$gst' WHERE  id=$id");	
...
<td><input name="name" type="text" id="name" maxlength="200"  class="round default-width-input" value="<?php echo $line->supplier_name ; ?> "/></td>
                   <td>Contact 1 </td>
                    ...
                    <tr>
                      <td>Email Id </td>
                      <td><input name="email" type="text" id="email" maxlength="30"   class="round default-width-input" 
					  value="<?php echo $line->email; ?>" /></td>
					  <td>GST No. </td>
                      <td><input name="gst" placeholder="ENTER YOUR GST NO."type="text" id="gst" maxlength="20"   class="round default-width-input" 
					  value="<?php echo $line->gst; ?>" /></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
